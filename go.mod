...
replace (
	github.com/containerd/containerd => github.com/containerd/containerd v1.6.22 // for compatibilty with docker 20.10.24
	github.com/docker/docker => github.com/docker/docker v20.10.25+incompatible // rancher and rancher-machine requires docker 20.10.x
